...
images = glob.glob('/home/rnm-group2/group2/rnm_needle_placement/src/needle_placement/lab/rgb_images/*.png')
...
np.save('/home/rnm-group2/group2/rnm_needle_placement/src/needle_placement/lab/board_poses.npy', matrices)
