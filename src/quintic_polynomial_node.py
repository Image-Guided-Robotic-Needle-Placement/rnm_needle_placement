...
max_velocity = 2.5*0.0001  # 2.5 rad/s
max_acceleration = 25*0.00001  # 15.0 rad/s²
...
if __name__ == '__main__':
    rospy.init_node('quintic_polynomial_node')
    ...
    pub = rospy.Publisher('/desired_joint_positions', Float64MultiArray, queue_size=10)
